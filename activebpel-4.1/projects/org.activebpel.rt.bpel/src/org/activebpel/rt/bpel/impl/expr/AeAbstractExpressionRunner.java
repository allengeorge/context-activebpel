//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/expr/AeAbstractExpressionRunner.java,v 1.12 2007/04/05 01:40:3
/*
...
public abstract class AeAbstractExpressionRunner implements IAeExpressionRunner
{
         ...
         IAeExpressionRunnerContext aContext) throws AeException
   {
      ...
      {
         throw new AeBpelException(ex.getLocalizedMessage(), aContext.getAbstractBpelObject().getFaultFactory().getInvalidExpressionValue(IAeFaultFactory.TYPE_DEADLINE), ex);
      }
   }
         ...
         throws AeException
   {
      ...
      {
         throw new AeBpelException(pe.getLocalizedMessage(), aContext.getAbstractBpelObject().getFaultFactory().getInvalidExpressionValue(IAeFaultFactory.TYPE_DURATION), pe);
      }
   }
