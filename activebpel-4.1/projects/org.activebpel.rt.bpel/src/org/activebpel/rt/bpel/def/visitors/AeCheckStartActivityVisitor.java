//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/visitors/AeCheckStartActivityVisitor.java,v 1.7 2006/12/14 22:51:0
/*
...
public class AeCheckStartActivityVisitor extends AeAbstractDefVisitor implements IAeDefVisitor
{
    ...
    */
   public AeCheckStartActivityVisitor(IAeBaseErrorReporter aErrorReporter)
   {
   ...
   public void doValidation(List aCreateInstanceActivities)
   {
      ...
      for (Iterator iter = mErrorDefs.iterator(); iter.hasNext();)
      {
         ...
         mErrorReporter.addError(AeMessages.getString("AeCheckStartActivityVisitor.ERROR_CREATE_INSTANCE_VALIDATION"), new String [] {}, def); //$NON-NLS-1$
      }
   }
