//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/validation/activity/AeBPWSActivityThrowValidator.java,v 1.2 2006/09/11 23:06:2
/*
...
public class AeBPWSActivityThrowValidator extends AeActivityThrowValidator
{
   ...
   protected void validateVariable()
   {
      ...
      {
         getReporter().addError( ERROR_FAULT_MESSAGETYPE_REQUIRED,
