// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/expr/xpath/AeWSBPELXPathVariableContext.java,v 1.2 2006/09/07 15:06:2
/*
...
public class AeWSBPELXPathVariableContext implements VariableContext
{
    ...
    * @param aContext
    */
   public AeWSBPELXPathVariableContext(IAeFunctionExecutionContext aContext)
   {
   ...
   public Object getVariableValue(String aNamespaceURI, String aPrefix, String aLocalName) throws UnresolvableException
   {
      ...
      if (AeUtil.isNullOrEmpty(aNamespaceURI))
      {
         ...
         args.add(varRef.getVariableName());
         if (varRef.hasPartName())
            args.add(varRef.getPartName());
         try
         {
