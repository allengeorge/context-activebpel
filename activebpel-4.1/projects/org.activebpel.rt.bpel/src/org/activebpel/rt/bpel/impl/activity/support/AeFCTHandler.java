//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/activity/support/AeFCTHandler.java,v 1.2 2006/06/26 16:50:4
/*
...
public abstract class AeFCTHandler extends AeActivityParent implements IAeFCTHandler
{
   ...
   public AeActivityCompensateImpl getCoordinatedActivityCompensator()
   {
      ...
      {
         mCoordinatedCompensator = AeActivityCompensateImpl.createImplicitCompensation(this, true);
      }
