//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/AeExpressionLanguageFactory.java,v 1.6 2006/10/25 16:08:0
/*
...
public class AeExpressionLanguageFactory implements IAeExpressionLanguageFactory
{
   ...
   static
   {
      try
      {
         ...
         sDefaultFatories.put(IAeBPELConstants.BPWS_NAMESPACE_URI, map);

         map = new HashMap();
         map.put("Class", AeWSBPELExpressionLanguageFactory.class.getName()); //$NON-NLS-1$
         sDefaultFatories.put(IAeBPELConstants.WSBPEL_2_0_NAMESPACE_URI, map);
      }
      catch (Throwable t)
      {
    ...
    * @return
    */
   protected static String getMappedNamespace(String aNamespace)
   {
