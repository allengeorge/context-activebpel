// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/visitors/AeProcessSnapshotVisitor.java,v 1.8 2006/11/03 22:48:0
/*
...
public class AeProcessSnapshotVisitor extends AeImplTraversingVisitor
{
   ...
   public void visit(AeActivityInvokeImpl aImpl) throws AeBusinessProcessException
   {
      ...
      // If this invoke is in the executing state and it is not queued for retry, then it's a pending invoke.
      if (aImpl.getState() == AeBpelState.EXECUTING && (! aImpl.isQueued()) )
      {
