// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/engine/storage/AePersistentQueueManager.java,v 1.25 2006/09/18 17:59:5
/*
...
public class AePersistentQueueManager extends AeInMemoryQueueManager
{
   ...
   protected boolean internalRemoveAlarm(long aProcessId, int aLocationPathId, int aAlarmId) throws AeBusinessProcessException
   {
      ...
      return removed && super.internalRemoveAlarm(aProcessId, aLocationPathId, aAlarmId);
   }
