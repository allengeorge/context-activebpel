// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/engine/AeEngineAdministration.java,v 1.68 2007/08/09 19:14:3
/*
...
public class AeEngineAdministration implements IAeEngineAdministration
{
   ...
   protected List createBuildInfo()
   {
      ...
      list.add(new AeBuildInfo("ActiveBPEL Runtime (ae_rt)", org.activebpel.rt.AeBuildNumber.getBuildNumber(), AeBuildInfo.convertCVSDateString(org.activebpel.rt.AeBuildNumber.getBuildDate()))); //$NON-NLS-1$
      list.add(new AeBuildInfo("ActiveBPEL Core (ae_rtbpel)", org.activebpel.rt.bpel.AeBuildNumber.getBuildNumber(), AeBuildInfo.convertCVSDateString(org.activebpel.rt.bpel.AeBuildNumber.getBuildDate()))); //$NON-NLS-1$
      list.add(new AeBuildInfo("ActiveBPEL Server (ae_rtbpelsvr)", org.activebpel.rt.bpel.server.AeBuildNumber.getBuildNumber(), AeBuildInfo.convertCVSDateString(org.activebpel.rt.bpel.server.AeBuildNumber.getBuildDate()))); //$NON-NLS-1$

      AeBuildInfo.createBuildInfoFor(list, "org.activebpel.rt.axis.bpel.AeBuildNumber", "ActiveBPEL Axis (ae_rtaxisbpel)"); //$NON-NLS-1$ //$NON-NLS-2$
      AeBuildInfo.createBuildInfoFor(list, "org.activebpel.rt.tomcat.AeBuildNumber", "ActiveBPEL Tomcat (ae_rttomcat)"); //$NON-NLS-1$ //$NON-NLS-2$
