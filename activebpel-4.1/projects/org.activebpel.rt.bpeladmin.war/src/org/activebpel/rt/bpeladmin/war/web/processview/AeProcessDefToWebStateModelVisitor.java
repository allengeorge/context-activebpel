//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpeladmin.war/src/org/activebpel/rt/bpeladmin/war/web/processview/AeProcessDefToWebStateModelVisitor.java,v 1.13 2007/09/17 16:29:1
/*
...
public class AeProcessDefToWebStateModelVisitor extends AeProcessDefToWebModelVisitor
{
   ...
   static
   {
      ...
      SKIP_STATE_PROPERTY.add(IAeBPELConstants.TAG_PARTNERS);
         ...
         if (isForEachParallelSingleInstance())
         {
            ...
            if ( AeUtil.notNullOrEmpty( getPivotPath() ) )
            {
               ...
               for (int i = aStartValue; i <= aFinalValue; i++)
               {
                  ...
                  AeDefPathParallelVisitor.appendInstancePredicate(scopeInstancePath, i);
   ...
   protected void buildInstanceLocationPaths(String aBaseLocationPath, AeActivityScopeDef aChildScopeDef, int aInstanceCount)
   {
      ...
      IAeDefPathSegmentVisitor segmentVisitor = AeDefVisitorFactory.getInstance(getProcessDef().getNamespace()).createDefPathSegmentVisitor();
      AeDefPathParallelVisitor visitor = new AeDefPathParallelVisitor(segmentVisitor, aBaseLocationPath, aChildScopeDef);
      visitor.setInstanceValue(aInstanceCount);
      visitor.visit(aChildScopeDef);
   }
    ...
    * @see org.activebpel.rt.bpeladmin.war.web.processview.AeProcessDefToWebModelVisitor#setState(org.activebpel.rt.bpel.def.AeBaseDef, org.activebpel.rt.bpeladmin.war.web.processview.AeBpelObjectBase)
    */
