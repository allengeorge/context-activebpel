//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpeladmin.war/src/org/activebpel/rt/bpeladmin/war/web/processview/AeProcessDefToWebVisitorBase.java,v 1.15 2007/09/12 02:55:3
/*
...
public class AeProcessDefToWebVisitorBase implements IAeDefVisitor
{
    ...
    * @param aDef
    */
   protected void setBpelVersion11(AeBaseDef aDef)
   {
   ...
   {      
      if (aQName != null)
      {
         ...
         Iterator it = aRefDef.getPrefixesForNamespace(aQName.getNamespaceURI()).iterator();
         if (it.hasNext())
         {
    ...
    * @throws AeException
    */
   protected Element selectSingleElement(AeBaseDef aDef) throws AeException
   {
    ...
    * @throws AeException
    */
   protected Element selectSingleElement(AeBaseDef aDef, String aStateTagName) throws AeException
   {
