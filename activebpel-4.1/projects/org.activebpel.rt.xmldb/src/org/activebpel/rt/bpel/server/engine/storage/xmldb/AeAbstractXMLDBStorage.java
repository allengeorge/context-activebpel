//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.xmldb/src/org/activebpel/rt/bpel/server/engine/storage/xmldb/AeAbstractXMLDBStorage.java,v 1.1 2007/08/17 00:40:5
/*
...
public abstract class AeAbstractXMLDBStorage extends AeXMLDBObject implements IAeXMLDBStorage
{
    ...
    * 
    * FIXMEQ (xmldb) use this query() variant for all query-builder based queries - then make the above method private
    *
    * @param aXQueryKey
    * @param aFilter
    * @param aResponseHandler
