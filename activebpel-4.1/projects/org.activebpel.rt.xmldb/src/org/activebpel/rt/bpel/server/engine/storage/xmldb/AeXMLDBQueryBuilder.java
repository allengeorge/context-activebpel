//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.xmldb/src/org/activebpel/rt/bpel/server/engine/storage/xmldb/AeXMLDBQueryBuilder.java,v 1.3 2007/08/27 21:02:2
/*
...
public abstract class AeXMLDBQueryBuilder extends AeXMLDBObject
{
   ...
   protected void appendCountQuery(StringBuffer aBuffer) throws AeException
   {
      ...
      aBuffer.append("count("); //$NON-NLS-1$
