//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.xmldb/src/org/activebpel/rt/bpel/server/engine/storage/xmldb/process/AeXMLDBFilteredProcessListQueryBuilder.java,v 1.1 2007/08/17 00:40:5
/*
...
public class AeXMLDBFilteredProcessListQueryBuilder extends AeXMLDBQueryBuilder
{
   ...
   protected void appendAndConditions(AeProcessFilter aFilter, List aAndClauses) throws AeException
   {
      ...
      {
         aAndClauses.add("$proc/ProcessName/LocalPart = '" + aFilter.getProcessName().getLocalPart() + "'"); //$NON-NLS-1$ //$NON-NLS-2$
      }
