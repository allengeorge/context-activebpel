//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/validation/activity/AeBaseScopeValidator.java,v 1.2 2006/10/03 19:35:1
/*
...
public class AeBaseScopeValidator extends AeActivityValidator
{
    ...
    * @param aVarName
    */
   public AeVariableValidator getVariableValidator(String aVarName)
   {
      if (getVariablesValidator() != null)
      {
         return getVariablesValidator().getVariableValidator(aVarName);
      }
      return null;
   }
    ...
    */
   public AeVariableValidator getVariableValidator(String aName, String aFieldName, boolean aRecordReference)
   {
      AeVariableValidator validator = null;
      if (getVariablesValidator() != null)
      {
         validator = getVariablesValidator().getVariableValidator(aName);
      }
      
      if (validator == null)
         validator = super.getVariableValidator(aName, aFieldName, aRecordReference);
      return validator;
   }
