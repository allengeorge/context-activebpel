// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/io/readers/def/AeBPWSReaderVisitor.java,v 1.6 2006/11/02 19:21:2
/*
...
public class AeBPWSReaderVisitor extends AeReaderVisitor
{
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#readAssignVarDefAttributes(org.activebpel.rt.bpel.def.activity.support.AeVarDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#readActivityAttributes(org.activebpel.rt.bpel.def.AeActivityDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#visit(org.activebpel.rt.bpel.def.activity.AeActivityFlowDef)
    */
    ...
    * 
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#visit(org.activebpel.rt.bpel.def.activity.support.AeIfDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#visit(org.activebpel.rt.bpel.def.activity.AeActivityBreakDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#visit(org.activebpel.rt.bpel.def.activity.AeActivityContinueDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.io.readers.def.AeReaderVisitor#visit(org.activebpel.rt.bpel.def.activity.AeActivitySuspendDef)
    */
