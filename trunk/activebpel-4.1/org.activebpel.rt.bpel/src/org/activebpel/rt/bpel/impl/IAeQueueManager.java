...
public interface IAeQueueManager extends IAeManager
{
   ...
   /**
    * The subscription queue object contains all of the necessary information to perform
    * an invocation to a WSN producer for a given topic. The actual invoke operation is handled
    * at a different layer asynchronously.
    * @param aPlan may contain additional information from the deployment layer like invokeHandler or addressing information
   ...
   /**
    * The consumer factory invoke queue object has all the information required to create a BPEL
    * consumer using the bundled Muse. The actual invoke operation is handled
    * at a different layer asynchronously.
    * @param aPlan may contain additional information from the deployment layer like invokeHandler or addressing information
    * @param aCreateConsumerQueueObject The entry to add.
    */
