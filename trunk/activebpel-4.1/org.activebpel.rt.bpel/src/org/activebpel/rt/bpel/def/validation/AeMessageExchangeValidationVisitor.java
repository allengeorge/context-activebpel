//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/validation/AeMessageExchangeValidationVisitor.java,v 1.5 2007/02/09 03:47:4
/*
...
public class AeMessageExchangeValidationVisitor extends AeAbstractDefVisitor
{
    ...
    */
   public AeMessageExchangeValidationVisitor(IAeBaseErrorReporter aErrorReporter)
   {
   ...
   protected void validateMessageExchangeForReplies()
   {
      ...
      for (Iterator iter = mReceiveDefsToContexts.entrySet().iterator(); iter.hasNext();)
      {
         ...
         if (plinkDef != null)
         {
            ...
            {
               Object[] args = { receiveDef.getPartnerLink(), receiveDef.getOperation(), receiveDef.getMessageExchange() };
   ...
   protected void addError(String aKey, Object[] aArgs, Object aDef)
   {
      ...
      {
         getReporter().addWarning(aKey, aArgs, aDef);
      }
      else
      {
         getReporter().addError(aKey, aArgs, aDef);
      }
   }
