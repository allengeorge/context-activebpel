...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
   ...
   <tr>
     <td class="navHeaders" align="left" nowrap="true" width="20%">&nbsp;<ae:GetResource name="deployment_status" /></td>
           ...
           <tr>
             <td class="navItem" align="left" nowrap="true" width="20%">&nbsp;<a href="deployment_log_detail.jsp"><ae:GetResource name="deployment_log" />&nbsp;</td>
           </tr>
      <tr>
   ...
   <tr>
     <td class="navHeaders" align="left" nowrap="true" width="20%">&nbsp;<ae:GetResource name="process_status" /></td>
      ...
      <!-- TODO Summary page needs implementing disable for now
       <tr>
         <td class="navItem" align="left" nowrap="true" width="20%">&nbsp;<a href="summary.jsp"><ae:GetResource name="summary" /></a></td>
       </tr>
      -->
