// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.axis/src/org/activebpel/rt/axis/AeCatalogHelper.java,v 1.8 2007/08/13 22:28:2
/*
...
public class AeCatalogHelper
{
   ...
   public static String getCatalogWsdl(String aEntry, String aRequestURL) throws AeException
   {
      try
      {
         ...
         AeWsdlTrimmer.fixupImportReferences(aRequestURL, defCopy.getWSDLDef(), defCopy.getLocationHint());
