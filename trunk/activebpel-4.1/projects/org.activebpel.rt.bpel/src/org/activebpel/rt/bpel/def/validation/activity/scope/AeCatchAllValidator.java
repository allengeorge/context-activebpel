//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/validation/activity/scope/AeCatchAllValidator.java,v 1.1 2006/08/16 22:07:2
/*
...
public class AeCatchAllValidator extends AeBaseValidator
{
   ...
   public void validate()
   {
      ...
      if ( getDef().getActivityDef() == null )
         getReporter().addError( ERROR_EMPTY_FAULT_HANDLER, null, getDefinition() );
   }
}
