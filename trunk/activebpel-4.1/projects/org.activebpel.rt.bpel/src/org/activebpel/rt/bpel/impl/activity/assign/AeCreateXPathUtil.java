//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/activity/assign/AeCreateXPathUtil.java,v 1.6 2006/12/14 22:53:4
/*
   ...
   public static int convertIndex(String aExpr, Node aContext, IAeCopyOperationContext aCopyContext, IAeNamespaceContext aNamespaceContext) throws AeBusinessProcessException
   {
      ...
      if(! numberExpr)
      {
         try
         {
            ...
            {
               varContext = new AeWSBPELXPathVariableContext(functionExecContext);
            }
