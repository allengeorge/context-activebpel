// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/visitors/AeTraversalVisitor.java,v 1.14 2007/09/12 02:48:1
/*
...
public class AeTraversalVisitor implements IAeDefVisitor
{
    ...
    */
   public AeTraversalVisitor(IAeDefTraverser aTravers, IAeDefVisitor aVisitor)
   {
      setTravers(aTravers);
      setVisitor(aVisitor);
   }
    ...
    * @param aVisitor
    */
   public void setVisitor(IAeDefVisitor aVisitor)
   {
      mVisitor = aVisitor;
   }
