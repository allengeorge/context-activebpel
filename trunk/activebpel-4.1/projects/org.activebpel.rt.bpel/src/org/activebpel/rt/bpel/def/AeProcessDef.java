...
public class AeProcessDef extends AeScopeDef
{
   ...
   /** The 'subscription-based stateful process' flag. */
   private boolean mStatefulProcess;
   ...
   {
      return mStatefulProcess;
   }

   public void setStatefulProcess(boolean aStatefulProcess)
   {
      mStatefulProcess = aStatefulProcess;
   }
