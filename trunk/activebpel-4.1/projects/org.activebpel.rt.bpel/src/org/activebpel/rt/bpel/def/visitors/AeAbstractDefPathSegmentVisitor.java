//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/visitors/AeAbstractDefPathSegmentVisitor.java,v 1.8 2007/09/12 02:48:1
/*
 ...
 */
public abstract class AeAbstractDefPathSegmentVisitor implements IAeDefPathSegmentVisitor
{
   /** path the def  */
   ...
   {
      setPathSegment(IAeBPELConstants.TAG_PARTNER);
   }
   ...
   {
      setPathSegment(IAeBPELConstants.TAG_PARTNERS);
   }
   ...
   {
      setPathSegment(IAeBPELConstants.TAG_DOCUMENTATION);
   }
   ...
   {
      setPathSegment(IAeBPELConstants.TAG_EXTENSIBLE_ASSIGN);
   }
    ...
    * @return the path to use for the def or null if there is no path
    */
    ...
    * @param aPath
    */
   public void setPathSegment(String aPath)
   {
      mPathSegment = aPath;
   }
}
