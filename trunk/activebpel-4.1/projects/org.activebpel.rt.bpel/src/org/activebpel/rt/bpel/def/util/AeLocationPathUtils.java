//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/util/AeLocationPathUtils.java,v 1.5 2007/01/27 14:40:2
/*
...
public class AeLocationPathUtils
{
    ...
    *
    * @param aAncestorNodeWithInstanceInfo
    * @param aPathThatNeedsInstanceInfo
    */
   public static String addInstanceInfo(String aAncestorNodeWithInstanceInfo, String aPathThatNeedsInstanceInfo)
   {
      if (AeUtil.isNullOrEmpty(aAncestorNodeWithInstanceInfo))
      {
         return aPathThatNeedsInstanceInfo;
      }
      else
      {
         Set set = addInstanceInfo(Collections.singleton(aPathThatNeedsInstanceInfo), aAncestorNodeWithInstanceInfo);
