// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/validation/AeErrorReporter.java,v 1.7 2005/06/08 12:50:2
/*
...
public class AeErrorReporter implements IAeErrorReporter
{
    ...
    */
   private void addIssue( String aCode, Object[] aArgs, AeBaseDef aNode, HashMap aMap )
   {
   ...
   {
      addIssue( aErrorCode, aArgs, (AeBaseDef)aNode, getErrors() );
   }
   ...
   {
      addIssue( aWarnCode, aArgs, (AeBaseDef)aNode, getWarnings() );
   }
   ...
   {
      addIssue( aInfoCode, aArgs, (AeBaseDef)aNode, getInfos() );
   }
