// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/AeVariable.java,v 1.62 2007/07/26 18:20:4
/*
...
public class AeVariable implements IAeVariable, IAeCopyFromParent, Cloneable
{
   ...
   public void validate(boolean aAllowEmptyPartData) throws AeBpelException
   {
      ...
      {
         String msg = AeMessages.format("AeVariable.ERROR_4", new Object[] {getName(), errorMessage}); //$NON-NLS-1$
