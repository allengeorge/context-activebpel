//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpeladmin.war/src/org/activebpel/rt/bpeladmin/war/web/processview/AeBpelObjectBase.java,v 1.9 2006/10/05 22:44:1
/*
...
{   
    ...
    */
   public AeBpelObjectBase(String aTagName, AeBaseDef aDef)
   {
    ...
    * @param aDef bpel definition.
    */   
   public AeBpelObjectBase(String aTagName, String aIconName, AeBaseDef aDef)
   {
    ...
    */
   public AeBpelObjectBase(String aTagName, AeBaseDef aDef, String aName, String aLocationPath)
   {
    ...
    * @param aLocationPath location path of the definition.
    */   
   public AeBpelObjectBase(String aTagName, String aIconName, AeBaseDef aDef, String aName, String aLocationPath)
   {
      setTagName(aTagName);
