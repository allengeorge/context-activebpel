//$Header: /Development/AEDevelopment/projects/org.activebpel.rt/src/org/activebpel/rt/xml/schema/sampledata/castor/AeCastorStructureFactory.java,v 1.8 2007/08/10 02:13:0
/*
...
public class AeCastorStructureFactory
{
   ...
   private static AeSimpleElement createSimpleElementModel(ElementDecl aElementDecl)
   {
      ...
      aeElement.setDataType(new QName( type.getSchema().getSchemaNamespace(), type.getBuiltInBaseType().getName() ));

      // process enumerations.
      List enumerations = new ArrayList();
      Enumeration enumer = type.getLocalFacets();
      if ( enumer != null )
      {
      ...
      aeElement.setEnumRestrictions(enumerations);
