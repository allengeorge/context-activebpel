//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.axis.bpel/src/org/activebpel/rt/axis/bpel/invokers/AeRpcStyleInvoker.java,v 1.11 2007/04/23 21:35:0
/*
...
public class AeRpcStyleInvoker extends AeSOAPInvoker
{
    ...
    * @throws AeBusinessProcessException
    */
   protected Use getUse(AeInvokeContext aContext) throws AeBusinessProcessException
   {
      Use useObj = null;
    ...
    */
   protected void addOperationToCall(AeInvokeContext aContext, Use aUseFlag)
   {
    ...
    */
   protected void addParamsToOperation(OperationDesc aOperation, AeInvokeContext aContext, boolean aIsInput)
   {
    ...
    */
   protected void setupOperationQName(AeInvokeContext aContext)
   {
