//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/faults/AeWSBPELFaultMatchingStrategy.java,v 1.4 2006/10/17 21:23:0
/*
...
public class AeWSBPELFaultMatchingStrategy extends AeBaseFaultMatchingStrategy
{
    ...
    * with the higher priority takes precendence.
    */
    ...
    *       includes the type of the fault data in a substition group then the fault is passed to the identified 
    *       <catch> construct.
    */   
    ...
    *       part in a substituon group then the fault is passed to the identified <catch> construct with the 
    ...
    *       by an element and there exists a <catch> construct without a faultName attribute that has a
    *       faultVariable whose associated faultElement's QName includes the QName of the element used to define the
    *       part in a substitution gorup then the fault is passed to the identified <catch> construct with the 
    *       faultVariable initialized to the value in the single part's element.
    */
   ...
   {
      /**
       * @see org.activebpel.rt.bpel.def.faults.IAeFaultMatchingRule#getMatch( org.activebpel.rt.bpel.IAeContextWSDLProvider, 
   ...
   /**
    * Matches if the fault has an element that is a memeber of a substituion group headed by the catch element.
    * The catch has no falut name. Otherwise silmilar to above AeVariableOnly_WSBPEL. This is not a best match 
    * rule.    
    */
