// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/impl/lock/AeVariableLocker.java,v 1.7 2005/12/09 18:23:0
/*
...
public class AeVariableLocker implements IAeVariableLocker
{
   ...
   /**
    * Returns <true>true</code> if and only if the specified variable path is locked.
    *
    * @param aVariablePath
    */
