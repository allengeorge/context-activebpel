...
public interface IAeBusinessProcess
{
   ...
   /**
    * Dispatches subscribe data to a queued invoke.
    */
   public void dispatchSubscribeData(String aLocationPath, IAagSubscribeResponse subsResponse);
   ...
   /**
    * Sets the EPR for the WS-N consumer associated with this process
    */
   public void setConsumerEPR(EndpointReference consumerEPR);

   /**
    * Returns the EPR of the WS-N consumer associated with this process
    * @return
    */
