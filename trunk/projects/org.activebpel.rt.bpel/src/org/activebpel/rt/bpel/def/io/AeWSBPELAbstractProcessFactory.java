//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel/src/org/activebpel/rt/bpel/def/io/AeWSBPELAbstractProcessFactory.java,v 1.2 2006/10/12 20:15:2
/*
...
import org.activebpel.rt.bpel.def.io.registry.AeWSBPELAbstractProcessBpelRegistry;
...
public class AeWSBPELAbstractProcessFactory extends AeAbstractBpelFactory
{
   ...
   {
      return new AeWSBPELAbstractProcessBpelRegistry();
   }
}
