...
public interface IAeBPELConstants extends IAeConstants
{
   ...
   /** The preferred prefix for "Stateful BPEL" extenions. */
   public static final String SBPEL_EXTENSION_PREFIX = "sbpel"; //$NON-NLS-1$

   /** Active Endpoints 'allow process termination/compensation' extension namespace declaration. */
   public static final String SBPEL_EXTENSION_NAMESPACE_URI_STATEFUL_PROCESS = "http://ece.uwaterloo.ca/aag/statefulbpel"; //$NON-NLS-1$
   ...
   public static final String TAG_STATEFUL = "isStateful"; //$NON-NLS-1$
