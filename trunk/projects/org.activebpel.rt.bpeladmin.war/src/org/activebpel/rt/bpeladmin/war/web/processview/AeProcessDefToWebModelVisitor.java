//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpeladmin.war/src/org/activebpel/rt/bpeladmin/war/web/processview/AeProcessDefToWebModelVisitor.java,v 1.17 2007/09/14 00:55:0
/*
...
public class AeProcessDefToWebModelVisitor extends AeProcessDefToWebVisitorBase
{
    ...
    */
   protected String getDefName(AeBaseDef aDef)
   {
    ...
    */
   protected void initModel(AeBaseDef aDef, AeBpelObjectBase aBpelObject)
   {
    ...
    */
   protected void setState(AeBaseDef aDef, AeBpelObjectBase aBpelObject)
   {
    ...
    * @param aVisualModel
    */
   protected void traverse(AeBaseDef aDef, AeBpelObjectBase aVisualModel)
   {
   ...
   {
      Iterator it = aDef.getExtensionAttributeDefs();
      while (it.hasNext() )
      {
   ...
   /**
    * @see org.activebpel.rt.bpel.def.visitors.IAeDefVisitor#visit(org.activebpel.rt.bpel.def.activity.AeActivitySwitchDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.visitors.IAeDefVisitor#visit(org.activebpel.rt.bpel.def.activity.support.AeSwitchCaseDef)
    */
   ...
   /**
    * @see org.activebpel.rt.bpel.def.visitors.IAeDefVisitor#visit(org.activebpel.rt.bpel.def.activity.support.AeOtherwiseDef)
    */
   ...
   {
      AeBpelObjectBase model = new AeBpelObjectBase(IAeBPELConstants.TAG_PARTNER, aDef);
      traverse(aDef, model);
   }
   ...
   {
      AeBpelObjectContainer model = new AeBpelObjectContainer(IAeBPELConstants.TAG_PARTNERS, aDef);
      traverse(aDef, model);
   }
