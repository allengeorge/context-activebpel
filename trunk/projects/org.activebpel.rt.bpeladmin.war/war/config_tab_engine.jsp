...
<jsp:setProperty name="tabBean" property="selectedTabString" param="tab" /> 
   ...
   <ae:IfParamMatches property="isSubmit" value="true">
      ...
      <jsp:setProperty name="configBean" property="webServiceTimeout" param="ec_web_service_timeout" />
   ...
   <form name="ec_form" method="post" action="config.jsp">
      ...
      <tr>
         <td class="labelHeaders" align="left" nowrap="true" width="20%">&nbsp;<ae:GetResource name="web_service_timeout" />&nbsp;</td>
         <td align="left" colspan="2"><input type="text" cols="5" tabIndex="16" name="ec_web_service_timeout" value='<jsp:getProperty name="configBean" property="webServiceTimeout" />'/></td>
      </tr>
      <tr height="1">
        <td colspan="3" height="1" class="tabular"></td>
      </tr>
