//$Header: /Development/AEDevelopment/projects/org.activebpel.rt/src/org/activebpel/rt/xml/schema/AeSchemaUtil.java,v 1.13 2007/07/26 20:19:5
/*
...
public class AeSchemaUtil
{
   ...
   public static String getNamespaceURI(AttributeDecl aAttributeDecl)
   {
    ...
    /**
    * Gets the substitution group level for specified group head and group member. For the memeber element
    * donesnt belong the gorup, level = -1, If two elements belong to a gorup but in the same level, level =
