// $Header: /Development/AEDevelopment/projects/org.activebpel.rt/src/org/activebpel/rt/config/AeConfigurationUtil.java,v 1.8 2007/08/16 23:47:5
/*
...
public class AeConfigurationUtil
{
    ...
    *
    * @param aConfig The engine configuration map for the class.
    * @param aCtorArg The second argument (after confg map).
    ...
    * reflection to find the proper constructer and then calling that
   ...
   /**
    * Load entries from the passed element, note this routione is recursive.  It
